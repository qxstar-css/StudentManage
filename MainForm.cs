...
namespace StudentManage
{
    public partial class MainForm : Form
    {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void TsmiSearchStudentUser_Click(object sender, EventArgs e)
        { 
            StudentUserSearchForm stuUserSearchFrm = new StudentUserSearchForm();
            stuUserSearchFrm.Show();
